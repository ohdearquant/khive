...
| Capability                  | How                                                                                                                                                      |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **70 verbs, 11 packs**      | KG, GTD, memory, comm, schedule, knowledge, session, git, code, workspace, blob: all load by default                                                     |
...
All 11 packs load by default, giving **70 verbs** out of the box (regenerate with
...
MCP client discovers the `request` tool with the full 70-verb catalog.
...
**v0.5.0 (publication pending; crates.io currently serves 0.4.0).** 70 verbs across 11
packs, 9 entity kinds, 17 edge relations, daemon warm startup (ADR-049), knowledge search with
embedding rerank, threaded messaging, scheduled verb execution.
