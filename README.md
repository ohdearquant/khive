...
| Capability                  | How                                                                                                                                                      |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **134 verbs, 14 packs**     | KG, GTD, memory, brain, comm, schedule, knowledge, session, tool, exec, git, code, workspace, blob: all load by default                                  |
...
All 14 packs load by default, giving **134 verbs** out of the box (updated from the
...
| ------------- | ------------ | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **kg**        | _(bare)_     | 25    | Entities, edges, notes, graph queries, reference resolution, caller identity, WAL diagnostics                                                                         |
...
┌──────────────────────────────────────────────────────────────┐
│  khive-pack-kg:        KG vocabulary + 25 verb handlers       │
...
MCP client discovers the `request` tool with the full 134-verb catalog.
...
**Main after v0.7.0.** 134 verbs across 14 packs, 9 entity kinds, 17 edge relations, daemon warm startup
