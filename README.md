...
| Capability                  | How                                                                                                                                                      |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **126 verbs, 14 packs**     | KG, GTD, memory, brain, comm, schedule, knowledge, session, tool, exec, git, code, workspace, blob: all load by default                                  |
...
All 14 packs load by default, giving **126 verbs** out of the box (updated from the
...
MCP client discovers the `request` tool with the full 126-verb catalog.
...
**Main after v0.7.0.** 126 verbs across 14 packs, 9 entity kinds, 17 edge relations, daemon warm startup
