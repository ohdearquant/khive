...
| Capability                  | How                                                                                                                                                      |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **136 verbs, 14 packs**     | KG, GTD, memory, brain, comm, schedule, knowledge, session, tool, exec, git, code, workspace, blob: all load by default                                  |
...
All 14 packs load by default, giving **136 verbs** out of the box (updated from the
...
| **gtd**       | `gtd.`       | 6     | Task lifecycle (inbox → next → active → done)                                                                                                                         |
...
│  khive-pack-gtd:       task lifecycle (6 verbs)               │
...
MCP client discovers the `request` tool with the full 136-verb catalog.
...
**Main after v0.7.0.** 136 verbs across 14 packs, 9 entity kinds, 17 edge relations, daemon warm startup
