...
def main():
    ...
    try:
        ...
        # unset) loads 11 production packs (kg, gtd, memory, comm, schedule,
        # knowledge, session, git, code, workspace, blob), so verbs() returns exactly
        # 70 user-facing MCP-callable verbs (count what verbs() returns, not internal
        ...
        assert verbs_result["total"] == 70, (
            f"expected 70 user-facing verbs from the 11 default packs "
