...
exposing one tool — `request` — that dispatches 84 verbs across 11 packs.
...
this plugin currently ships pattern skills for the first seven; `session`, `git`, `workspace`,
