...
The KG pack provides 23 verb handlers for the knowledge graph substrate: entity
...
| [`src/handler_defs.rs`](../src/handler_defs.rs)                   | KG_HANDLERS static table (23 HandlerDef entries)         |
| [`src/handlers/mod.rs`](../src/handlers/mod.rs)                   | 23 verb handler implementations                          |
