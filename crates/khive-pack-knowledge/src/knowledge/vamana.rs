...
// without breaking the atomic lock protocol. Refactoring is deferred until ADR-049
// defines a stable snapshot format and the warm-start contract stabilizes.
