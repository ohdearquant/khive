...
### ADR-025: Verb Surface as Speech-Act Taxonomy - Illocutionary Verb Classification
...
### ADR-027: Dynamic Pack Loading via Self-Registration - Inventory Self-Registration
...
### ADR-032: Brain as Profile-Orchestration over Fold + Objective - Brain-Tunable Parameters
...
### ADR-033: Recall Pipeline - Configurable Multi-Stage Memory Retrieval - Recall Reranking and Weighted Fusion
...
### ADR-043: Embedding Model Migration - CJK Routing for Multilingual Embedding
...
### ADR-002: Closed Edge Ontology - Edge Ontology - Supersedes Suppression
...
### ADR-023: Pack Verb Surface, Visibility, and Composition - Dotted Sub-Handler Naming
