    ...
    HandlerDef {
        ...
        params: &[
            ...
            ParamDef {
                ...
                param_type: "string",
                required: false,
                description: "Recurrence: \"daily\" | \"weekly\" | \"monthly\" | \"every:<N><s|m|h|d>\" (an interval from the previous trigger, e.g. \"every:15m\") | a five-field cron expression in UTC (e.g. \"0 9 * * 1\"). Anything else is rejected at creation, so a stored recurrence is always one the executor can advance.",
                resolution_mode: IdResolutionMode::NotApplicable,
            },
        ],
    },
