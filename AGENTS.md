...
| `traverse`       | **roots** (UUID list); max_depth, direction, relations, min_weight, limit, include_roots; `include_properties` (bool, default false: when true each path node carries its entity `properties` map). Returns exactly one traversal object per distinct root. Resolvable entity and note nodes both carry `name` and `kind`; note names use the same `[kind]` fallback as `neighbors`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `{"roots":["<uuid>"],"max_depth":2}`                           |
