...
All 10 packs load by default. **81 public verbs** across the packs: the `git` pack
...
3; Amendment 2's `code.ingest` verb is accepted but unimplemented). Regenerate via
