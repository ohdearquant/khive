...
| `db_diagnostics` | WAL/checkpoint operator diagnostics: counters, PASSIVE probe, WAL size, holder census (probe may backfill WAL frames — normal checkpoint I/O, never TRUNCATE) | Diagnosing writer stalls or WAL growth on a live store                  |
...
| `db_diagnostics` | No fields. Returns `{build, db_path, wal_file, checkpoint_counters, checkpoint_probe, checkpoint_probe_error, wal_pin}`. The PASSIVE checkpoint probe may backfill WAL frames into the database (normal checkpoint I/O); it never changes logical state, escalates to TRUNCATE, creates a missing database file, or deletes WAL-pin sidecar evidence. Unavailable sections carry explicit reasons rather than being omitted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `{}`                                                           |
