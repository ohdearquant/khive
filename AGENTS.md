...
| `brain.mark_turn`        | Emit a best-effort per-actor work-unit marker                                            | Supply the discipline-ratio denominator                         |
...
| `comm.unread`    | Count unread inbound messages without returning payloads                                                                     | Cheap unread-count check                      |
