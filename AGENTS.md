...
| `traverse`       | **roots** (UUID list, max 100 raw entries, de-duplicated after resolve); max_depth (default 3, max 10), direction (default both), relations, min_weight, limit (non-roots per root, default 100, max 1,000), include_roots (default true), include_properties (default false). One request shares a 100,000-adjacency-row and 5-second storage-expansion budget across visible namespaces; over-budget calls return no partial paths. Reads use statement-scoped snapshots.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `{"roots":["<uuid>"],"max_depth":2}`                           |
