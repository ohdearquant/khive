...
A research knowledge graph runtime — 90 verbs, 12 packs, one MCP tool.
...
| ------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| **kg**        | 20    | Entities, edges, notes, graph queries, proposals                                                                                                 |
...
| **comm**      | 9     | Threaded messaging with sender-side internal delivery confirmation                                                                               |
