...
loads all 11 production packs: kg, gtd, memory, comm, schedule, knowledge, session, git,
code, workspace, blob (verbs at 70: the `code` pack contributes one verb, `code.ingest`
