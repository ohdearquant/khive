...
│  134 public verbs (see the verb-catalog paragraph below       │
...
| `crates/khive-pack-kg`          | KG pack: vocabulary, 25 verb handlers, kind validation                                                                                                                                                                                                                                                                                                                            |
...
### KG pack verbs (25 — ADR-017, ADR-046, ADR-089, ADR-174)
...
| `restore`        | `id`, `kind?`                                                                                                       | Restore a caller-owned soft-deleted record; live record = idempotent no-op; a note whose key is held by a live note is refused                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
