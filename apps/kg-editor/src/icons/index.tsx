...
// Geometry is copied from Lucide under the adjacent ISC license; this renderer
// fixes the application-wide visual contract so callers cannot drift it.
const ICON_SHAPES = {
  "activity": (
...
export const ICON_NAMES = Object.freeze(
  Object.keys(ICON_SHAPES) as IconName[],
);

type FixedSvgAttribute =
  | "children"
  | "fill"
  | "height"
  | "stroke"
...
export type IconProps = Omit<SVGProps<SVGSVGElement>, FixedSvgAttribute>;
export type IconComponent = (props: IconProps) => ReactElement;

export function Icon({ name, ...props }: IconProps & { name: IconName }) {
  const ariaHidden = props["aria-label"] === undefined &&
...
function icon(name: IconName): IconComponent {
  return function SharedIcon(props) {
...
export const ChartNoAxesCombined = icon("chart-no-axes-combined");
...
export const CircleDot = icon("circle-dot");
export const CircleHelp = icon("circle-help");
...
export const FileJson2 = icon("file-json");
export const FileText = icon("file-text");
export const FolderKanban = icon("folder-kanban");
export const GitBranch = icon("git-branch");
export const GitCommitHorizontal = icon("git-commit");
...
export const ServerCog = icon("server-cog");
export const ShieldCheck = icon("shield-check");
export const Signpost = icon("signpost");
...
export const XCircle = icon("x-circle");
