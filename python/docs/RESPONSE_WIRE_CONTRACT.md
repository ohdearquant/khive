...
## Keyed message outcomes

`Session.send` and `Session.reply` return the single validated raw per-operation
outcome. A keyed success carries `idempotency_key`, `replayed`, the outbound
`full_id` and the inbound `recipient_id`. Matching replay retains both IDs and
the original timestamp and thread. It creates no pair and does not repeat a
reply's parent mark-read. Inbox/thread properties and inbound read responses
retain the logical key; field projection can return it directly (R16).

Different requests sharing a live key, and missing or inconsistent recipient
copies, use the existing structured conflict family: `details.reason` is
`key_conflict`, with the logical `key` and outbound `existing_id`.
`domain_disposition=not_committed` describes this attempt. If the winning holder
disappears after a competing pair rolls back, `key_holder_unresolved` instead
has unknown disposition. These methods preserve errors without an automatic
operation retry. Deleting the outbound releases the live key (R17).
...
| R6   | crates/khive-pack-kg/src/handlers/get.rs -- "Err(RuntimeError::NotFound(format!(\"not found: {id_ref}\")))"; crates/khive-runtime/src/error.rs -- "pub(crate) fn after_handler(source: RuntimeError, domain_succeeded: bool) -> Self {"; crates/khive-runtime/src/error_projection.rs -- "json!({\"kind\":\"runtime_error\", \"message\":other.to_string()})"; crates/khive-runtime/src/error_projection.rs -- "value[\"domain_disposition\"] = json!(disposition.as_str());"; crates/khive-mcp/src/server.rs -- "let projected = khive_runtime::runtime_error_value(error, disposition);"; crates/khive-mcp/src/server.rs -- "let mut value = error_with_disposition(projected, disposition);"; crates/khive-mcp/src/server.rs -- "value[\"domain_disposition\"] = json!(projected_disposition.as_str());" |
| R7   | crates/khive-runtime/src/error_projection.rs -- "other.writer_task_failure_context()"; crates/khive-runtime/src/error_projection.rs -- "\"storage\""; crates/khive-runtime/src/error_projection.rs -- "context.stage"; crates/khive-runtime/src/error_projection.rs -- "other.to_string()"; crates/khive-runtime/src/error_projection.rs -- "context.retryable"; crates/khive-runtime/src/error_projection.rs -- "context.request_state.to_string()"; crates/khive-runtime/src/error_projection.rs -- "context.task_terminated"                                                                                                                                                                                                                                                                             |
...
| R9   | crates/khive-runtime/src/error_projection.rs -- "other.retryable_failure_context()"; crates/khive-runtime/src/error_projection.rs -- "\"unavailable\""; crates/khive-runtime/src/error_projection.rs -- "context.timeout.as_millis()"; crates/khive-runtime/src/error_projection.rs -- "context.capability.map(storage_capability_wire_name)"; crates/khive-runtime/src/error_projection.rs -- "context.operation"; crates/khive-runtime/src/error_projection.rs -- "context.scope"; crates/khive-runtime/src/error_projection.rs -- "context.retry_after_ms"; crates/khive-runtime/src/error.rs -- "pub const WRITER_ADMISSION_SCOPE: &str = \"writer_admission\";"                                                                                                                                        |
| R10  | crates/khive-runtime/src/error_projection.rs -- "RuntimeError::Khive(k) => serde_json::to_value(&k)"; crates/khive-types/src/khive_error.rs -- "pub struct KhiveError {"; crates/khive-types/src/khive_error.rs -- "code: Option<ErrorCode>,"; crates/khive-types/src/khive_error.rs -- "details: Option<Details>,"; crates/khive-types/src/khive_error.rs -- "s.serialize_str(&self.to_string())"; crates/khive-types/src/khive_error.rs -- "map.serialize_entry(k.as_ref(), v.as_ref())?;"                                                                                                                                                                                                                                                                                                                |
...
| R14  | crates/khive-runtime/src/error.rs -- "Self::Committed => \"committed\","; crates/khive-runtime/src/error.rs -- "Self::NotCommitted => \"not_committed\","; crates/khive-runtime/src/error.rs -- "Self::Unknown => \"unknown\","; crates/khive-runtime/src/error_projection.rs -- "RuntimeError::AuditObligation"; crates/khive-runtime/src/error_projection.rs -- "error.insert(\"domain_result\".into(), domain_result);"; python/khive/models.py -- "Literal[\"committed\", \"not_committed\", \"unknown\"]"                                                                                                                                                                                                                                                                                              |
| R15  | crates/khive-runtime/src/daemon.rs -- "pub error: Option<String>,"; crates/khive-runtime/src/daemon.rs -- "pub error_detail: Option<serde_json::Value>,"; crates/khive-runtime/src/daemon.rs -- "pub const PROTOCOL_VERSION: u32 = 7;"; crates/khive-mcp/src/daemon.rs -- "fn daemon_mcp_error("; crates/khive-mcp/src/daemon.rs -- "fn protocol_mismatch_error("; python/khive/transport.py -- "error_detail=_validate_frame_error_detail(response, \"daemon\")"                                                                                                                                                                                                                                                                                                                                           |
| R16  | crates/khive-pack-comm/src/idempotency.rs -- "response[\"recipient_id\"] = props[\"inbound_ref\"].clone();"; crates/khive-pack-comm/src/idempotency.rs -- "response[\"replayed\"] = json!(replayed);"; crates/khive-pack-comm/src/handlers.rs -- "let marked_read = if replayed"; crates/khive-pack-comm/src/message.rs -- "\"idempotency_key\","                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| R17  | crates/khive-pack-comm/src/idempotency.rs -- "(\"reason\", \"key_conflict\".into()),"; crates/khive-pack-comm/src/idempotency.rs -- "(\"existing_id\", holder.to_string()),"; crates/khive-runtime/src/error_projection.rs -- "(khive_types::ErrorKind::Conflict, Some(\"key_conflict\" \u007c \"fence_conflict\")) => {"; crates/khive-runtime/src/error_projection.rs -- "(khive_types::ErrorKind::Unavailable, Some(\"key_holder_unresolved\")) => Some(\"unknown\"),"; crates/khive-runtime/src/keyed_message.rs -- "AND key = ?2 AND deleted_at IS NULL LIMIT 1"; python/khive/transport.py -- "Return one raw comm.reply outcome without retrying operation errors."                                                                                                                                  |
