...
two: it takes the decoded ops-array form and renders it as DSL text.
...
def render_dsl(ops: list[dict[str, Any]], *, chained: bool = False) -> str:
    ...
    """
    rendered = [_render_op(entry) for entry in ops]
    if not rendered:
        return ""
