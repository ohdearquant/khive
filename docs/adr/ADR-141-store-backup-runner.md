...
An occupied lock SHALL produce an explicit terminal `skipped_overlap` result and a nonzero exit unless the supervisor has declared the invocation an intentional no-op. [ADR-100:45-48]
