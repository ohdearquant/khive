...
| `brain.profile(id)`                                             | assertive            | Verb       | Metadata, latest snapshot, current state summary                                                                                                                                                                                                                                                                                       |
| `brain.resolve(actor?, namespace?, consumer_kind)`              | assertive            | Verb       | Show which profile would serve this caller context                                                                                                                                                                                                                                                                                     |
...
| `brain.bind(profile_id, actor?, namespace?, consumer_kind?)`    | declaration          | Verb       | Write a row in the resolution table                                                                                                                                                                                                                                                                                                    |
| `brain.unbind(profile_id?, actor?, namespace?, consumer_kind?)` | declaration          | Verb       | Remove rows from the resolution table                                                                                                                                                                                                                                                                                                  |
| `brain.feedback(target_event_id, score, reason?)`               | commissive           | Verb       | Emit a `FeedbackExplicit` event into the shared log                                                                                                                                                                                                                                                                                    |
...
| `brain.emit`                                                    | assertive            | Internal   | Manually emit an event (testing)                                                                                                                                                                                                                                                                                                       |
