...
| [ADR-081](ADR-081-recall-retune-driver.md)                              | Recall Retune Driver — Governed Ingestion of Implicit Feedback                                             |
...
| [ADR-103](ADR-103-resource-attribution-model.md)                        | Resource Attribution Model                                                                                 |
| [ADR-104](ADR-104-posterior-serving-recall.md)                          | Profile Posteriors in the Recall Read Path                                                                 |
| [ADR-105](ADR-105-cross-node-comm-transport.md)                         | Cross-node comm transport (node channel adapter + hub ingress)                                             |
| [ADR-106](ADR-106-schedule-pack-executor.md)                            | Schedule Pack Executor — Daemon-Resident Tick for the Pending-Event Drain                                  |
| [ADR-107](ADR-107-memory-ann-lifecycle.md)                              | Memory ANN Lifecycle — Eventual Consistency Contract                                                       |
...
| [ADR-121](ADR-121-attachments-first-class.md)                           | Attachments — Role-Keyed Blob Renditions as a First-Class Substrate Property                               |
| [ADR-122](ADR-122-email-outbound-delivery.md)                           | Email outbound delivery — outbox contract and supervised delivery component                                |
...
- [ADR-121 Amendment 3](ADR-121-attachments-first-class.md#amendment-3-2026-09-25-rows-whose-record-is-gone-are-reported-now-and-no-scan-removes-them-until-a-reviewed-design-exists) (2026-09-25): rows whose record is gone are reported now, and no scan removes them until a reviewed design exists.
