...
> demand through `blob.sweep`, or live on demand through `kkernel blob sweep --live`. Attachment
> rows alone do not protect durable exec, git and derived web objects in the shared root.
