...
now decided by the ADR-091 Amendment 8 ownership claim, with a bounded fallback only for
...
Amendment 8, the effective value is decided by the checkpoint-ownership claim and is not
configurable.)
