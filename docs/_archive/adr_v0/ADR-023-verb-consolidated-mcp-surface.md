...
the _MCP wire shape_ — as of v0.2 these verbs are dispatched through a single `request` tool, not
exposed as separate MCP tools.\
**Date**: 2026-05-15\
**Authors**: Ocean, lambda:khive

> **2026-05-18 update.** This ADR's _verb taxonomy_ (11 verbs with `kind=` discriminant) is still
...
> [ADR-020](ADR-020-request-dsl.md). Examples below stay valid as the _verb-name portion_ of a
